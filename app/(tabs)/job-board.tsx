        ...
        >
          {availableShifts.length > 0 ? (
              ...
              {availableShifts.map((shift) => (
                <View key={shift.id} style={styles.shiftCard}>
                  <View style={styles.shiftHeader}>
                    <ThemedText style={styles.dayText}>{shift.day}</ThemedText>
                    {shift.location && (
                      <ThemedText style={styles.locationText}>{shift.location}</ThemedText>
                    )}
                  </View>
            ...
            <View style={styles.emptyState}>
              <IconSymbol name="briefcase.fill" size={48} color="#999" weight="regular" />
              <ThemedText style={styles.emptyText}>No available shifts</ThemedText>
